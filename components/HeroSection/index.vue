<template>
  ...
  >
    ...
    <div
      class="absolute bottom-0 left-0 w-full h-[200px] bg-gradient-to-t from-[#131313] to-transparent z-10"
    ></div>
  </section>
</template>
...
.position {
  background: -webkit-linear-gradient(#5fe9d6, #0e949e);
